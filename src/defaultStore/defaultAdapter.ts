import {JsonGraphStore} from "./jsonGraphStore";
import process from "process";
import {Qwiery} from "~/qwiery";

export   async function DefaultAdapter(options = {}, done) {
	const api = {
		//region Nodes
	...
	const mem = new JsonGraphStore(options["memory"] || {});
