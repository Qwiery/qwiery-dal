...
import {JsonGraphStore} from "../src/defaultStore/jsonGraphStore";
import {RandomGraph, JsonGraph,Graph} from "@orbifold/graphs";
import { toPredicate } from "../src/defaultStore/projections";
